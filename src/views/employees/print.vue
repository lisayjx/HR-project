...
<script>
import { getPersonalDetail, getPersonalJobs } from '@/api/employees'
...
export default {
  ...
  // 创建完毕状态
  created() {
    this.type === 'personal' ? this.getPersonalDetail() : this.getPersonalJobs()
  },
  // 组件更新
  methods: {
    ...
    async getJobDetail() {
      ...
      const jobInfo = await getPersonalJobs(this.userId)
